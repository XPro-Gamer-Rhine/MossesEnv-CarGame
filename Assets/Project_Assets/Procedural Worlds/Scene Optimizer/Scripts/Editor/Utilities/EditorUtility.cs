...
namespace ProceduralWorlds.SceneOptimizer
{
    public static class EditorUtility
    {
        ...
        public static Mesh SaveMeshToDisk(string folderPath, Mesh sharedMesh)
        {
            ...
            var asset = AssetDatabase.LoadAssetAtPath<Mesh>(filePath);
            if (asset != null)
                return asset;
            AssetDatabase.CreateAsset(sharedMesh, filePath);
            sharedMesh.name = assetName;
        ...
        public static CullingSystem GetCullingSystem()
        {
            CullingSystem cullingSystem = Object.FindObjectOfType<CullingSystem>();
