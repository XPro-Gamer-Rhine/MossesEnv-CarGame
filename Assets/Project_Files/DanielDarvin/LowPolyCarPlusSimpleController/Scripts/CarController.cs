...
public class CarController : MonoBehaviour
{
     ...
     void Move()
    {
     ...
     void EnableBrake(WheelCollider wheel)
    {
     ...
     void DisableBrake(WheelCollider wheel)
    {
        m_dragTime = 2.0f;
     ...
     void TireMarksEffect(bool state)
    {
     ...
     void DustEffect(bool state)
    {
     ...
     void EasySuspension(WheelCollider wheel)
    {
