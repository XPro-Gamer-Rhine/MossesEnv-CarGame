...
public class DriftCamera : MonoBehaviour
{
    ...
    //private CamLookAtTarget cam;

    //private void Awake()
    //{
    //    cam = FindObjectOfType<CamLookAtTarget>();
    //}

    //private void Start()
    //{
    //    cam.CamLookTarget(lookAtTarget.transform);
    //}
    ...
    public void SetPositionTarget(Transform _position)
    {
        positionTarget = _position;
    }

    public void SetSideView(Transform _sideView)
    {
        sideView = _sideView;
    }
}
